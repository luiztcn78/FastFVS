...
import 'package:fastfvs_front/utils/foto_perfil_utils.dart';
...
class PaginaBaseState extends State<PaginaBase> {
  ...
  Widget build(BuildContext context) {
    ...
    final fotoPerfil = construirImagemPerfil(SessaoUsuario.usuario?.fotoPerfil);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {},
            icon: fotoPerfil != null
                ? CircleAvatar(
                    radius: iconTamanho / 2,
